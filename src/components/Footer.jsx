...
const Footer = () => {
  ...
  return (
    <footer className="relative border-t bg-neutral-950 border-neutral-800">
      <div className="max-w-5xl px-6 py-16 mx-auto md:px-8">
        <div className="grid grid-cols-1 gap-12 mb-12 md:grid-cols-3">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h3 className="mb-4 text-2xl text-white font-editorial-ultralight">
              Yogiraj Shinde
            </h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="mb-4 text-sm font-medium tracking-wider uppercase text-neutral-400">Quick Links</h4>
            <ul className="space-y-2">
              {navLinks.map((link) => (
                <li key={link}>
                  <a
                    href={`#${link.toLowerCase()}`}
                    className="text-sm transition-colors duration-300 text-neutral-500 hover:text-teal-400"
                  >
                    {link}
                  </a>
                </li>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h4 className="mb-4 text-sm font-medium tracking-wider uppercase text-neutral-400">Get In Touch</h4>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="pt-8 text-center border-t border-neutral-800"
        >
